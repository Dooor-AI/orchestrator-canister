...
import { idlFactory } from './cert_manager_backend.did.js';
export { idlFactory } from './cert_manager_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CERT_MANAGER_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cert_manager_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cert_manager_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cert_manager_backend.did.js")._SERVICE>}
 */
export const cert_manager_backend = createActor(canisterId);
